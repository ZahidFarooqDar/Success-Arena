...
using SuccessArenaBAL.Foundation.Config.Dependency;
using SuccessArenaBAL.Foundation.Odata;


namespace SuccessArenaBAL.Foundation.Web
{
    public static class Extentions
    {
        public static int GetUserRecordIdFromCurrentUserClaims(this ClaimsPrincipal claimsPrincipal)
        {
