...
namespace SuccessArenaFoundation.Controllers.AppUsers
{
    ...
    public partial class ApplicationUserController : ApiControllerWithOdataRoot<ApplicationUserSM>
    {
        ...
        [HttpGet("mine")]
        [Authorize(AuthenticationSchemes = SuccessArenaBearerTokenAuthHandlerRoot.DefaultSchema, Roles = "SuperAdmin,ClientAdmin, BlogAdmin, SystemAdmin")]
        ...
        [HttpPut("mine")]
        [Authorize(AuthenticationSchemes = SuccessArenaBearerTokenAuthHandlerRoot.DefaultSchema, Roles = "SystemAdmin, SuperAdmin, BlogAdmin")]
        ...
        [Authorize(AuthenticationSchemes = SuccessArenaBearerTokenAuthHandlerRoot.DefaultSchema, Roles = "SystemAdmin, SuperAdmin")]
