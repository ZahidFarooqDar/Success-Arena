...
{
    public class SuccessArenaBearerTokenAuthHandlerRoot : AuthenticationHandler<SuccessArenaAuthenticationSchemeOptions>
    {
        private string _failureMsg = string.Empty;
        private readonly JwtHandler _jwtHandler;

        public const string DefaultSchema = "SuccessArenaBearerSchema";

        public SuccessArenaBearerTokenAuthHandlerRoot(IOptionsMonitor<SuccessArenaAuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, JwtHandler jwtHandler)
